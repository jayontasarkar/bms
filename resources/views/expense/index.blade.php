        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <div class="selectgroup w-100">
                        <label class="selectgroup-item select-days">
                            <input type="radio" name="days" value="1" class="selectgroup-input" {{ request('days') == 1 ? 'checked' : '' }}>
                            <span class="selectgroup-button">1</span>
                        </label>
                        <label class="selectgroup-item select-days">
                            <input type="radio" name="days" value="7" class="selectgroup-input" {{ request('days') == 7 ? 'checked' : '' }}>
                            <span class="selectgroup-button">7</span>
                        </label>
                        <label class="selectgroup-item select-days">
                            <input type="radio" name="days" value="15" class="selectgroup-input" {{ request('days') == 15 ? 'checked' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <div class="selectgroup w-100">
                        @for($i = 1; $i <= 4; $i++) <label class="selectgroup-item select-months">
                            <input type="radio" name="months" value="{{ $i }}" class="selectgroup-input" {{ request('months') == $i ? 'checked' : '' }}>
                            <span class="selectgroup-button">{{ $i }}</span>
                            </label>
                            @endfor
                    </div>
                    <div class="selectgroup w-100">
                        @for($i = 5; $i <= 8; $i++) <label class="selectgroup-item select-months">
                            <input type="radio" name="months" value="{{ $i }}" class="selectgroup-input" {{ request('months') == $i ? 'checked' : '' }}>
                            <span class="selectgroup-button">{{ $i }}</span>
                            </label>
                            @endfor
                    ...
                    <div class="selectgroup w-100">
                        @for($i = 9; $i <= 12; $i++) <label class="selectgroup-item select-months">
                            <input type="radio" name="months" value="{{ $i }}" class="selectgroup-input" {{ request('months') == $i ? 'checked' : '' }}>
                            <span class="selectgroup-button">{{ $i }}</span>
                            </label>
                            @endfor
                                ...
                                <td>
                                    <ul class="list-inline mt-3">
                                        <li class="list-inline-item">
                                            <edit-expense :expense="{{ json_encode($expense) }}" :url="'{{ route('expenses.update', [$expense]) }}'" :vendors="{{ json_encode($vendors) }}"></edit-expense>
                                        </li>
                                        <li class="list-inline-item">
